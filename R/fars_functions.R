...
#'
#' @param filename a character vector of a filename of a csv file to read
#'
...
#'
#' \code{make_filename} will create a character vector filename with an associated year input
#'
#' This takes a year input and creates a filename with this year.
#' If the year does not pass \code{as.integer} it will have a value of NA, and the function
...
#'
#' \code{fars_read_years} takes a vector of years that iterates over them to
